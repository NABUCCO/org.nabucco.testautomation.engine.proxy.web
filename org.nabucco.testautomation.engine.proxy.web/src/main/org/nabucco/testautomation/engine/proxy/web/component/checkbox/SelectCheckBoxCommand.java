...
/**
 * SelectCheckBoxCommand
 * 
 * @author Steffen Schmidt, PRODYNA AG
 */
public class SelectCheckBoxCommand extends AbstractWebComponentCommand {

    /**
     * @param selenium
     */
    public SelectCheckBoxCommand(Selenium selenium) {
        super(selenium);
    }
    ...
    public PropertyList executeCallback(Metadata metadata, PropertyList properties) throws WebComponentException {
        ...
        this.getSelenium().click(checkBoxId);
        this.stop();
