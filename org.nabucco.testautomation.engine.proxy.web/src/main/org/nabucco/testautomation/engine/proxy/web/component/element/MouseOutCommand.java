 ...
 */
class MouseOutCommand extends AbstractWebComponentCommand {

    /**
     * Creates a new {@link MouseOutCommand} instance.
     * 
     * @param selenium
     *            the selenium instance
     */
    protected MouseOutCommand(Selenium selenium) {
        super(selenium);
    }
    ...
    public PropertyList executeCallback(Metadata metadata, PropertyList properties) throws WebComponentException {
        ...
        this.getSelenium().mouseOut(element);
        this.stop();
