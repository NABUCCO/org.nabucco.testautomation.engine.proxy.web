 ...
 */
class GetAvailabilityCommand extends AbstractWebComponentCommand {
    ...
    public PropertyList executeCallback(Metadata metadata, PropertyList properties) throws WebComponentException {
        ...
        BooleanProperty property = (BooleanProperty) PropertyHelper.getFromList(properties, PropertyType.BOOLEAN)
                .cloneObject();
