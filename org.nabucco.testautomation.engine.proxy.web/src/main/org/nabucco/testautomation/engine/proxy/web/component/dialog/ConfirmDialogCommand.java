 ...
 */
public class ConfirmDialogCommand extends AbstractWebComponentCommand {

    /**
     * @param selenium
     */
    public ConfirmDialogCommand(Selenium selenium) {
        super(selenium);
    }
    ...
    public PropertyList executeCallback(Metadata metadata, PropertyList properties) throws WebComponentException {
        ...
        this.start();
        this.getSelenium().chooseOkOnNextConfirmation();
        this.stop();
        return null;
    }
