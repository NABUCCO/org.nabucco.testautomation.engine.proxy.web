...
/**
 * ClearTextFieldCommand
 * 
 * @author Steffen Schmidt, PRODYNA AG
 */
public class ClearTextFieldCommand extends AbstractWebComponentCommand {

	/**
	 * @param selenium
	 */
	public ClearTextFieldCommand(Selenium selenium) {
		super(selenium);
	}
	...
	public PropertyList executeCallback(Metadata metadata,
        ...
        this.getSelenium().type(textFieldId, EMPTY_STRING);
        this.stop();
