...
public enum WebActionType implements SubEngineActionType {
    ...
    /**
     * The ActionType for a mouse hover.
     */
    MOUSEOVER("Hover over the element"),

    /**
     * The ActionType for a mouse out.
     */
    MOUSEOUT("Move the mouse away from the element"),
     ...
     * The ActionType to get a table cell.
     */
    COUNT_ROWS("Get the number of rows in a table"),
    ...
    /**
     * The ActionType to read an attribute.
     */
